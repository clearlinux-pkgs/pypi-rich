...
Source0  : https://files.pythonhosted.org/packages/92/76/40f084cb7db51c9d1fa29a7120717892aeda9a7711f6225692c957a93535/rich-13.8.1.tar.gz
...
%prep
%setup -q -n rich-13.8.1
cd %{_builddir}/rich-13.8.1
pushd ..
cp -a rich-13.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725978962
