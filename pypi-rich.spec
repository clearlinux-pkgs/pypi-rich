...
Source0  : https://files.pythonhosted.org/packages/81/d2/64751634e1af18e61454e9946c8c792ab3866c2b309615844fc435036715/rich-11.1.0.tar.gz
...
%prep
%setup -q -n rich-11.1.0
cd %{_builddir}/rich-11.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643389906
...
cp %{_builddir}/rich-11.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
