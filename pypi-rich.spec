...
Source0  : https://files.pythonhosted.org/packages/cf/60/5959113cae0ce512cf246a6871c623117330105a0d5f59b4e26138f2c9cc/rich-13.8.0.tar.gz
...
%prep
%setup -q -n rich-13.8.0
cd %{_builddir}/rich-13.8.0
pushd ..
cp -a rich-13.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724690852
