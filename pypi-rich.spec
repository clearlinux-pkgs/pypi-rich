...
Source0  : https://files.pythonhosted.org/packages/88/fd/13ee53f8bdf538b64c8ed505a92d3bc1f2c0d1071173d65216af61e0e88b/rich-12.0.0.tar.gz
...
%prep
%setup -q -n rich-12.0.0
cd %{_builddir}/rich-12.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646938154
...
cp %{_builddir}/rich-12.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
