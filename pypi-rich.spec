...
Source0  : https://files.pythonhosted.org/packages/5e/0e/ef0a49be56dbc4052a086888cd2490e15fcc95b0eda79e9d0e737b1ab93d/rich-13.3.2.tar.gz
...
%prep
%setup -q -n rich-13.3.2
cd %{_builddir}/rich-13.3.2
pushd ..
cp -a rich-13.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677976750
