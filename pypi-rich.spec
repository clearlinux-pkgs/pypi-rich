...
Source0  : https://files.pythonhosted.org/packages/20/db/fb6f586e2869440d99601b30f6874842015b0c8ca1a6a094abf4e24163f5/rich-13.1.0.tar.gz
...
%prep
%setup -q -n rich-13.1.0
cd %{_builddir}/rich-13.1.0
pushd ..
cp -a rich-13.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673892775
