...
Source0  : https://files.pythonhosted.org/packages/8e/81/d59e9198a32206a156649a24a813a36a50461d9f6e669378c68aed974910/rich-12.0.1.tar.gz
...
%prep
%setup -q -n rich-12.0.1
cd %{_builddir}/rich-12.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647960873
...
cp %{_builddir}/rich-12.0.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
