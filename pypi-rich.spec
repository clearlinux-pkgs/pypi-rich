...
Source0  : https://files.pythonhosted.org/packages/11/23/814edf09ec6470d52022b9e95c23c1bef77f0bc451761e1504ebd09606d3/rich-12.6.0.tar.gz
...
%prep
%setup -q -n rich-12.6.0
cd %{_builddir}/rich-12.6.0
pushd ..
cp -a rich-12.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664807725
