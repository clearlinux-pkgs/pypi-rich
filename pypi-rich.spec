...
Source0  : https://files.pythonhosted.org/packages/dd/c4/5ad64e0a7e5a49b4dbe8d51decf448a118dab2c20dbdb71f6b7a5f10bc2f/rich-12.4.0.tar.gz
...
%prep
%setup -q -n rich-12.4.0
cd %{_builddir}/rich-12.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651946189
...
cp %{_builddir}/rich-12.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
