...
Source0  : https://files.pythonhosted.org/packages/9e/5e/c3dc3ea32e2c14bfe46e48de954dd175bff76bcc549dd300acb9689521ae/rich-13.2.0.tar.gz
...
%prep
%setup -q -n rich-13.2.0
cd %{_builddir}/rich-13.2.0
pushd ..
cp -a rich-13.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674166326
