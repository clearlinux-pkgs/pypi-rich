...
Source0  : https://files.pythonhosted.org/packages/2f/1a/91f38976d2ed0b955e683fdbaafebf94606ff238b1ef604438a06a6d695f/rich-13.0.1.tar.gz
...
%prep
%setup -q -n rich-13.0.1
cd %{_builddir}/rich-13.0.1
pushd ..
cp -a rich-13.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673018324
