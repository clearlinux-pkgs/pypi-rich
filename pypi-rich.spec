...
Source0  : https://files.pythonhosted.org/packages/f5/f3/f87be42279b5cfba09f7f29e2f4a77063ccf5d9075042981e2cf48752d51/rich-12.4.4.tar.gz
...
%prep
%setup -q -n rich-12.4.4
cd %{_builddir}/rich-12.4.4
pushd ..
cp -a rich-12.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656376491
...
cp %{_builddir}/rich-12.4.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
