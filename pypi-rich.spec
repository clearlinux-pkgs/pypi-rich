...
Source0  : https://files.pythonhosted.org/packages/72/4d/1f48abaa1e91474af1be8622ec2a8bd3768b306def47b064aa15aa943f95/rich-12.4.1.tar.gz
...
%prep
%setup -q -n rich-12.4.1
cd %{_builddir}/rich-12.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652030303
...
cp %{_builddir}/rich-12.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
