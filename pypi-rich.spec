...
Source0  : https://files.pythonhosted.org/packages/72/7b/aac2aa5df3de3ef8a809e5e4d7b35da0ed304f9c43fa25d5d728194790d6/rich-12.1.0.tar.gz
...
%prep
%setup -q -n rich-12.1.0
cd %{_builddir}/rich-12.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649035247
...
cp %{_builddir}/rich-12.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
