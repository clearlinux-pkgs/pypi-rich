...
Source0  : https://files.pythonhosted.org/packages/72/de/b3a53cf1dfdbdc124e8110a60d6c6da8e39d4610c82491fc862383960552/rich-11.2.0.tar.gz
...
%prep
%setup -q -n rich-11.2.0
cd %{_builddir}/rich-11.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644365094
...
cp %{_builddir}/rich-11.2.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-rich/aa95e7e0dbe72bae99f41dc862f0516da8ae35c2
