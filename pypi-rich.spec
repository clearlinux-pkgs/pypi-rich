...
Source0  : https://files.pythonhosted.org/packages/b3/01/c954e134dc440ab5f96952fe52b4fdc64225530320a910473c1fe270d9aa/rich-13.7.1.tar.gz
...
%prep
%setup -q -n rich-13.7.1
cd %{_builddir}/rich-13.7.1
pushd ..
cp -a rich-13.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709231719
