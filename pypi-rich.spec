...
Source0  : https://files.pythonhosted.org/packages/a1/53/830aa4c3066a8ab0ae9a9955976fb770fe9c6102117c8ec4ab3ea62d89e8/rich-14.0.0.tar.gz
...
%prep
%setup -q -n rich-14.0.0
cd %{_builddir}/rich-14.0.0
pushd ..
cp -a rich-14.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743428815
