...
Source0  : https://files.pythonhosted.org/packages/b4/b9/f735d18e35aea71b6516d2970d268fccf3978f4848156ed20cc858c287bd/rich-13.0.0.tar.gz
...
%prep
%setup -q -n rich-13.0.0
cd %{_builddir}/rich-13.0.0
pushd ..
cp -a rich-13.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672418208
